---
id: 01KYP5GR5W28MN3CR5HR1PMW4R
number: 579909000
type: artifact
schema: artifact/v1.1
name: 'Slice 06 (Arc 04): Enrich `origin`+`decomposed` + wire `check`/`rollup`/`orient`'
created: 2026-06-29
updated: 2026-06-29
origin: planned
reserved: false
source:
  paths:
  - docs/design-v1.0.0/arc04-index-cache/slice06-views-and-check/ledger.md
  class: ledger
