---
id: 01KYP5GQPWMAGXZGX35YQVH3E2
number: 598502000
type: artifact
schema: artifact/v1.1
name: 'CC Prompt — Slice 06 (Arc 04): Enrich `origin`+`decomposed` + wire `check`/`rollup`/`orient`'
created: 2026-06-29
updated: 2026-06-29
origin: planned
reserved: false
source:
  paths:
  - docs/design-v1.0.0/arc04-index-cache/slice06-views-and-check/cc-prompt.md
  class: cc-prompt
