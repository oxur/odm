---
id: 01KWXMBBTKC6GYF33YYKPTXVM2
number: 1406
type: slice
schema: slice/v1.1
name: Enrich `origin`+`decomposed` + wire `check`/`rollup`/`orient`
created: 2026-06-29
updated: 2026-07-28
origin: planned
reserved: false
source:
  paths:
  - /Users/oubiwann/lab/oxur/odm/.worktrees/1.0.x/docs/design-v1.0.0/arc04-index-cache/slice06-views-and-check/slice-doc.md
  class: slice-doc
