# Makefile for the odm (ODD Document Manager) Rust Project
...
push:
	...
	@echo "$(CYAN)• origin (GitHub):$(RESET)"
	@git push origin main && git push origin --tags
	@echo "$(GREEN)✓ Pushed$(RESET)"

# Crates in dependency order. odm depends on the published oxur-cli (crates.io),
# so this workspace only publishes oxur-odm itself.
PUBLISH_ORDER := oxur-odm
