...
> the *corrected* command, so **s14 blocks the freeze**. Arc-close resumes after s14 CDC-closes:
> freeze → P-12 → close. *Plan late, plan deep.*
