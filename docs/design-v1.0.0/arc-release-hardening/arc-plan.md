...
### Batch 2 — 2026-07-26 (surfaced during C-1/C-2 — implementation and validation)
...
### v1.7 — 2026-07-26
**C-3 closed (RH-3 attested); F-4…F-9 + F-15 dispositioned.** `odm list` now reads as a plan:
